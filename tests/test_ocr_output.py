...
from ocr_app.handlers.output.json_process import JsonProcessor
from ocr_app.handlers.output.image_process import OutputImageProcessor
...
def test_OutputHandler_process_output():
    imgs, data = genImg_text(num_boxes=10)
    dummy_model_output = OcrResults(imgs, data)
